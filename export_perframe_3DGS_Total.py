...
for index, viewpoint in enumerate(scene.getVideoCameras()):
    points, scales_final, rotations_final, opacity_final, shs_final = get_state_at_time(gaussians, viewpoint[0])
    ...
    gs_ply.write(os.path.join(output_path,f"time_{index}.ply"))
print("done")
