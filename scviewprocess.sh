workdir=$1
python scripts/extractimages.py scview/$workdir
...
mkdir ./data/scview/$workdir/sparse_
cp -r ./colmap_tmp/sparse/0/* ./data/scview/$workdir/sparse_
...
python scripts/downsample_point.py ./colmap_tmp/dense/fused.ply ./data/scview/$workdir/points3D_scview.ply

python imgs2poses.py ./colmap_tmp/

cp ./colmap_tmp/poses_bounds.npy ./data/scview/$workdir/poses_bounds_scview.npy
